...
let favoriteNumberis = 2; //my favourite number,
...
favoriteModeOfTransportation.forEach((favoriteModeOfTransportation) => console.log(`I would like to own a  ${favoriteModeOfTransportation} .`));
...
invites.forEach((invitation) => console.log(` Hi ${invitation}, I would like to invite you for a dinner today, at my house ..As new dinner table won’t arrive in time for the dinner,  its a sunday today so lets catch up today at dinner on 8:00 PM and captured a beautiful moments.... `));
...
guestinvites.forEach((invitation) => console.log(` Hi ${invitation}, I would like to invite you for a dinner today, at my house ..
...
let middleGuest = Math.floor(newguestinvites.length / 2);
newguestinvites.splice(middleGuest, 0, "Mariam");
newguestinvites.forEach((invitation) => console.log(` Hi ${invitation}, I would like to invite you for a dinner today, at my house ..
    As its a sunday today so lets catch up today at dinner on 8:00 PM and captured a beautiful moments.... `));
...
let middGuest = Math.floor(shrinkGuestList.length / 2);
shrinkGuestList.splice(middleGuest, 0, "Mariam");
shrinkGuestList.forEach((invitation) => console.log(` Hi ${invitation}, I would like to invite you for a dinner today, at my house ..
    As its a sunday today so lets catch up today at dinner on 8:00 PM and captured a beautiful moments.... `));
...
// ANS37:
function make_Shirt(size = "large", printmassage = "I love TypeScript") {
